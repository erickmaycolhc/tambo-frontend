...
import SearchStoreGlobal from "../search-stores/search-store-global";
import MenuIcon from '@mui/icons-material/Menu';

export default function ComponentMapTamboGlobal() {
    ...
    <div style={{ width: "100%" }}>
      {currentLocation !== null ? (
        ...
        <GoogleMap
          ...
          <div className="search-store-component-global">
            <SearchStoreGlobal />
          </div>
          <Grid >
          ...
          {arrayStoresTambo.map((tienda, index) => {
            return (
              <MarkerF
                key={tienda.id}
